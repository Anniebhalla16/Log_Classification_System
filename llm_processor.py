...
if __name__ == "__main__":
    ...
    print(classify_with_llm("The Report Generator module will be retired in version 4.0. Please migrate."))
    print(classify_with_llm("System reboot initialized by User 123."))